...
encoder.fit(X_test_categoricalImputed)

# Trainsform the testing and training categorical columns
X_train_onehot = encoder.transform(X_TrainingCategoricalImputed)
X_test_onehot = encoder.transform(X_test_categoricalImputed)
...
# Plot outputs
plt.scatter(y_test, y_test,  color='black', label='y_test') # Observed y values
plt.scatter(y_test, y_predictionTesting, color='blue', label='y_pred') # predicted y values
